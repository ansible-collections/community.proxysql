...
We recommend using the [AGENTS.md](https://github.com/ansible-collections/community.proxysql/blob/main/AGENTS.md) file and [skills](https://github.com/ansible-collections/community.proxysql/tree/main/.agents/skills) provided in this repository when contributing with AI tools.
